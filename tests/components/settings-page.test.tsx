...
describe("SettingsPage", () => {
  ...
  it("renders profile, billing, and security controls from live user data", async () => {
    ...
    expect(await screen.findByDisplayValue("SceneSelf Builder")).toBeInTheDocument();
    expect(screen.getByDisplayValue("SceneSelf Builder")).toBeInTheDocument();
  ...
  it("saves the updated profile name through the authenticated profile route", async () => {
    ...
    await screen.findByDisplayValue("SceneSelf Builder");
