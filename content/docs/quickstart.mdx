---
title: Quickstart
description: Get your SceneSelf project running in minutes.
---
...
Fetch the code with Git:

```bash
git clone https://github.com/Idea-To-Business/sceneself.git
cd sceneself
```
...
- [Scene Generation](./scene) — Configure the Scene engine and OpenRouter
