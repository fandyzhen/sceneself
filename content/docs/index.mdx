...
SceneSelf is a **production-grade AI SaaS template** designed for rapid launch of commercial AI products. It includes everything you need: authentication, subscription billing, credit system, AI integrations (chat, image, video), admin dashboard, and i18n support.
