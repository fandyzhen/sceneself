...
export const STORYLINE_TYPES: StorylineTypeDef[] = [
  ...
  },
  {
    ...
    allowSelfie: true,
    allowModernProps: false,
    attireHint: "occasion-specific outfit, locked color across the WHOLE set. Output every piece with explicit color+material. By occasion: wedding bride → 'ivory satin floor-length gown, matching veil, ivory satin heels, simple pearl earrings'; wedding groom → 'black wool tuxedo jacket, black tuxedo trousers, white pleated dress shirt, black silk bow tie, black patent leather shoes'; graduation → 'black graduation gown, black mortarboard cap with gold tassel on the right side (CAP MUST BE WORN in every beat), regular shoes underneath'; gala/award → choose by the subject's gender presentation in the reference selfie (or the user's explicit request): a man → 'black tuxedo, white dress shirt, black bow tie, black leather oxfords'; a woman → 'single-color (specify) floor-length evening gown, matching heels'; BUSINESS / SHOP / CAFE OPENING (opening my own cafe, shop launch, small-business grand opening — this is SMART-CASUAL, NOT black-tie, and NOT a chef) → 'natural cream or charcoal linen apron with a chest pocket over a fitted dark t-shirt OR a light blue oxford shirt with rolled sleeves, dark indigo jeans, white minimal sneakers — an approachable indie owner, NO chef toque, NO chef jacket, NO tuxedo/gown'. For weddings/graduations/galas only: NO casual jeans/sneakers/t-shirts. For a shop/cafe opening, the smart-casual owner look above is correct.",
  },
  {
    id: "profession",
    label: "职业身份",
    ...
    test: /ceo|总裁|创始人|医生|律师|飞行员|机长|厨师|主厨|咖啡师|咖啡店|开店|艺术家|设计师|程序员|教师|executive|founder|doctor|lawyer|pilot|chef|barista|caf[eé]|coffee\s*shop|artist/i,
    era: "modern",
    allowSelfie: true,
    allowModernProps: false,
    attireHint: "the profession's COMPLETE real uniform — output as a comma list with EVERY required piece, color + material. CRITICAL DISAMBIGUATION: a 'cafe' / 'coffee shop' owner or barista is NOT a restaurant chef — use the INDIE CAFE look below, NEVER chef whites. MANDATORY full sets (the headwear/hat item MUST be the FIRST item in the outfit string when the role requires one, never omit it): INDIE CAFE / COFFEE SHOP OWNER / BARISTA (opening a cafe, third-wave coffee, owner/barista shots) → 'natural cream or charcoal linen apron with a chest pocket (NOT a white double-breasted chef jacket, NOT a toque), fitted dark charcoal cotton t-shirt OR a light blue oxford shirt with rolled sleeves, dark indigo wash jeans, white minimal leather sneakers' — think a Blue Bottle / Sightglass cafe owner, ABSOLUTELY NO chef toque, NO double-breasted chef jacket, NO checkered chef trousers, NO culinary-school whites, NO formal suit; fine-dining / restaurant chef (Michelin kitchen, NOT a cafe) → 'tall white chef toque hat (mandatory headwear), crisp white double-breasted chef jacket with rolled sleeves, black or dark grey checkered chef trousers, white knee-length bistro apron (white, not khaki or beige)'; doctor → 'white knee-length lab coat over light blue surgical scrubs, black stethoscope around the neck, white sneakers'; surgeon → 'light blue surgical scrub cap (mandatory headwear), light blue surgical mask pulled down at the neck, light blue scrub top and trousers'; pilot → 'four-stripe black captain peaked cap (mandatory headwear), navy airline jacket with four gold sleeve stripes and gold wings pin on the chest, matching navy trousers, white shirt, black tie, black leather shoes'; executive → 'sharp charcoal wool tailored blazer, matching charcoal trousers or pencil skirt, crisp white shirt, leather oxford shoes'. Accessory should be a SIMPLE held/worn item (NEVER a small tool/spoon tucked into a pocket — those render as floating objects).",
  },
  {
    id: "transformation",
    label: "蜕变成长",
  ...
  },
  {
    ...
    allowSelfie: true,
    allowModernProps: true,
    attireHint: "ONE locked travel outfit fitting the destination, output every piece with explicit color+material. Destination-specific MANDATORY pieces (hat/cap MUST be the FIRST item when sun/beach/snow is implied): beach/tropical → 'beige straw wide-brim sun hat (mandatory headwear), white linen short-sleeve button-up shirt, tan linen shorts, leather sandals, brown canvas tote'; cold city (Tokyo winter, Paris autumn) → 'charcoal wool overcoat, cream cashmere scarf, dark blue jeans, black leather Chelsea boots, black leather crossbody bag'; warm city (Bali, summer Europe) → by the subject's gender: a woman → 'pale yellow cotton sundress, tan leather sandals, woven beach bag, gold-rim sunglasses'; a man → 'pale linen short-sleeve button-up shirt, beige linen shorts, tan leather sandals, gold-rim sunglasses'; cruise/yacht → 'navy and white striped boatneck top, white linen wide-leg trousers, white canvas espadrilles, gold-rim sunglasses, beige sun hat'; ski/snow trip → 'red insulated ski jacket, black ski trousers, white knit beanie (mandatory headwear), black snow boots, black ski gloves'. NEVER write 'travel outfit' alone — list every piece.",
  },
];
