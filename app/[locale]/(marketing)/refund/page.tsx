    ...
    <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-24">
      <div className="prose prose-invert max-w-none prose-headings:text-stone-50 prose-headings:tracking-tight prose-h1:font-medium prose-h1:italic prose-h2:text-amber-100 prose-a:text-amber-300 prose-a:no-underline hover:prose-a:underline prose-strong:text-amber-100 prose-li:marker:text-amber-300/60 prose-p:text-stone-300 prose-li:text-stone-300">
        ...
        <section className="mb-8">
          ...
          <p>
            At SceneSelf, we strive to ensure customer satisfaction with our products and services. This Refund Policy outlines the conditions under which you may request a refund and the process for doing so.
          </p>
          <p>
        ...
        <section className="mb-8">
          ...
          <p>
            Send an email to support@sceneself.com with the following information:
          </p>
          <ul className="list-disc pl-6 space-y-2">
        ...
        <section className="mb-8">
          ...
          <p>
            For eligible subscription refunds across our three subscription tiers (weekly, monthly, yearly):
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Yearly plans: Pro-rated for unused months</li>
            <li>Monthly plans: Generally no pro-rating</li>
            <li>Weekly plans: Generally no pro-rating; you can cancel anytime to stop the next renewal</li>
            <li>Credits already consumed: Not refundable; undelivered credits (e.g. when a scene set is not delivered) are returned automatically per our delivery rules</li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mt-6 rounded-2xl border border-amber-200/15 bg-amber-200/[0.05] p-4">
