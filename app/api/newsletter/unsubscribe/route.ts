  ...
  try {
    ...
    const html = `
      ...
      <head>
        ...
        <title>Unsubscribed - SceneSelf</title>
        <style>
          body {
      ...
      <body>
        <div class="container">
          ...
          <p>
            You have been successfully unsubscribed from the SceneSelf newsletter. 
            We're sorry to see you go!
          </p>
          <p>
            You can resubscribe anytime from our website.
          </p>
          <a href="${process.env.NEXT_PUBLIC_APP_URL}">Back to SceneSelf</a>
        </div>
      </body>
      </html>
    `;
