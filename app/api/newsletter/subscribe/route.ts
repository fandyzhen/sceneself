...
export async function POST(request: NextRequest) {
  try {
    ...
    if (existing && existing.length > 0) {
      ...
      await sendEmail({
        to: email,
        subject: "Welcome back to SceneSelf Newsletter!",
        html: `
          <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto;">
            <h1 style="color: #333;">Welcome Back!</h1>
            <p>You've successfully resubscribed to the SceneSelf newsletter.</p>
    ...
    await sendEmail({
      to: email,
      subject: "Welcome to SceneSelf Newsletter!",
      html: `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto;">
          <h1 style="color: #333;">Welcome to SceneSelf Newsletter!</h1>
